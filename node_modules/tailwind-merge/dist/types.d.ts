...
declare const getDefaultConfig: () => {
    ...
    readonly classGroups: {
        ...
        readonly 'gradient-from-pos': readonly [{
            readonly from: readonly [(value: string) => boolean, (value: string) => boolean];
        }];
        /**
        ...
        readonly 'gradient-via-pos': readonly [{
            readonly via: readonly [(value: string) => boolean, (value: string) => boolean];
        }];
        /**
        ...
        readonly 'gradient-to-pos': readonly [{
            readonly to: readonly [(value: string) => boolean, (value: string) => boolean];
        }];
        /**
