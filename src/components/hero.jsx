    ...
    >
      ...
      <div className="container px-4 py-16 md:py-0 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 relative z-10">
        ...
        <div className="flex-1 text-center lg:text-left max-w-2xl">
          ...
          >
            <div className={`inline-flex items-center px-3 py-1.5 rounded-full font-medium backdrop-blur-sm ${isDark
        ...
        >
          <div className="relative w-full max-w-md">
            <div className="relative">
              ...
              <motion.div
                className={`absolute bottom-6 right-6 backdrop-blur-sm px-4 py-2 rounded-xl border shadow-md flex items-center gap-2 ${isDark
              ...
              {/* Decorative elements */}
              <div className={`absolute -top-4 -left-4 w-16 h-16 rounded-2xl backdrop-blur-sm border shadow-lg flex items-center justify-center ${isDark
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <div className={`w-10 h-16 border-2 rounded-full flex justify-center p-1 backdrop-blur-sm ${isDark ? 'border-slate-700/50' : 'border-gray-300/50'
            }`}>
            <motion.div
